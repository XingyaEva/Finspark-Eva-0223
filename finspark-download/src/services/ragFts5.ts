...
const FINANCIAL_PHRASES = [
  ...
  // 公司名称
  '贵州茅台', '五粮液', '泸州老窖', '洋河股份',
  '比亚迪', '宁德时代', '招商银行', '中国平安', '中信证券',
  '北方华创', '海天味业', '药明康德', '迈瑞医疗', '隆基绿能',
  // 银行/金融特有
  '不良贷款', '拨备覆盖率', '资本充足率', '核心一级资本',
  '净息差', '利息净收入', '手续费收入', '资产管理', '资产托管',
  '零售银行', '公司银行', '金融科技', '数字化转型',
  // 用户/业务指标
  '月活跃用户', '活跃用户', '用户数量', '客户数量', '市场份额',
  '新能源汽车', '动力电池', '储能系统', '半导体设备',
  // 治理/战略
  '董事长致辞', '管理层讨论', '风险因素', '研发投入',
  '分红方案', '股权激励', '战略规划', '核心竞争力',
];
