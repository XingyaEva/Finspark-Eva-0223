...
// 使用 Map 构建避免 TypeScript 重复键警告
const _pinyinEntries: [string, string][] = [
  // 常见公司名称用字
  ...
  ['测', 'ce'], ['试', 'shi'], ['计', 'ji'], ['代', 'dai'], ['积', 'ji'],
  ['微', 'wei'], ['纳', 'na'], ['米', 'mi'], ['量', 'liang'],
  ['刻', 'ke'], ['曝', 'bao'], ['显', 'xian'], ['影', 'ying'], ['像', 'xiang'],
  ['传', 'chuan'], ['感', 'gan'], ['器', 'qi'], ['模', 'mo'], ['拟', 'ni'], ['混', 'hun'],
  ['频', 'pin'], ['射', 'she'], ['存', 'cun'], ['闪', 'shan'], ['读', 'du'],
  ['写', 'xie'], ['控', 'kong'], ['处', 'chu'], ['理', 'li'], ['运', 'yun'],
  ['算', 'suan'], ['逻', 'luo'], ['辑', 'ji'],
  // 国际相关
  ['际', 'ji'], ['环', 'huan'], ['球', 'qiu'], ['世', 'shi'], ['界', 'jie'], ['全', 'quan'],
  ['亚', 'ya'], ['欧', 'ou'], ['非', 'fei'], ['洲', 'zhou'], ['太', 'tai'],
];
const PINYIN_MAP: Record<string, string> = Object.fromEntries(_pinyinEntries);
